package br.com.core.android.compose.utils.permission
...
object PermissionUtils {
    ...
    /**
     * Função que simplifica um pouco a solicitação de multiplas permissões,  tornando opcional a
     * passagem de um callback executado no resultado.
     *
     * @see [rememberLauncherForActivityResult]
     *
     * @param onResult
