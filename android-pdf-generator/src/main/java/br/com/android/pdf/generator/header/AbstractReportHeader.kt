...
import br.com.android.pdf.generator.utils.Position

/**
 * Implementação base para um cabeçalho de relatório ([IReportHeader]).
 *
 * Fornece uma estrutura padrão de cabeçalho contendo um logotipo à esquerda e um título
 * à direita, seguido por uma linha horizontal.
 *
