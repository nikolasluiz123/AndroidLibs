package br.com.android.pdf.generator.components.table
...
import br.com.android.pdf.generator.components.table.layout.CellLayout
import br.com.android.pdf.generator.components.table.layout.ColumnLayout
import br.com.android.pdf.generator.components.table.layout.RowLayout
import br.com.android.pdf.generator.components.table.layout.TableLayoutCache
...
/**
 * Um componente [IReportComponent] que renderiza dados em formato de tabela.
 *
 * A tabela é altamente configurável, permitindo a definição de larguras percentuais,
 * alinhamento horizontal e vertical para cada coluna. Ela também gerencia automaticamente
 * a quebra de texto (wrap) dentro das células e a quebra de página para linhas longas.
 *
 * @param columnLayouts A lista de configurações ([ColumnLayout]) para cada coluna da tabela.
 * @param rows A lista de linhas, onde cada linha é uma lista de strings representando as células.
 *
...
class TableComponent<FILTER : Any>(
    ...
    /**
     * Armazena em cache o layout pré-calculado da tabela ([RowLayout] e [CellLayout])
     * após a fase de medição, para ser reutilizado na fase de desenho.
     */
    private var tableLayoutCache: TableLayoutCache? = null

    /**
     * Armazena em cache a altura total calculada da tabela para evitar recálculos.
     */
