package br.com.android.ui.compose.components.layout
...
/**
 * Um layout de grade que organiza seus componentes filhos em um número de colunas que se ajusta ao espaço disponível,
 * respeitando um número máximo de colunas.
 *
 * @param modifier O [Modifier] a ser aplicado ao layout.
 * @param maxColumns O número máximo de colunas que a grade pode ter.
 * @param content O conteúdo `Composable` a ser exibido dentro da grade.
 *
